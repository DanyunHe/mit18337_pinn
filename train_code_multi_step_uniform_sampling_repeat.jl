...
for stepi in 1:dt_steps
        ...
        if stepi==1 #first timestepping, use initial data available, uniform sampling
                ...
                open("./uniform_repeat/PINN_sample_x_u_uniform_repeat_$(q)_$(dt)_$(stepi)_0.txt", "a") do file
                ...
                open("./uniform_repeat/PINN_sample_x_u_uniform_repeat_fullarray_$(q)_$(dt)_$(stepi)_0.txt", "a") do file
        ...
        @save "./uniform_repeat/PINN_NN_model_uniform_repeat_$(q)_$(dt)_$(stepi)_0" NN
        open("./uniform_repeat/PINN_iter_loss_MSE_uniform_repeat_$(q)_$(dt)_$(stepi).txt", "a") do file
...
# -uniform
                        ...
                        open("./uniform_repeat/PINN_sample_x_u_uniform_repeat_$(q)_$(dt)_$(stepi)_$(total_iteration_i).txt", "a") do file
                            writedlm(file, [data_tn_x data_tn_u], ',')
                            flush(file)
                        end
                end
                ...
                @save "./uniform_repeat/PINN_NN_model_uniform_repeat_$(q)_$(dt)_$(stepi)_$(total_iteration_i)" NN
        ...
        #save error to file
        open("./uniform_repeat/PINN_error_uniform_repeat.txt", "a") do file
        ...
        savefig(img,"./uniform_repeat/PINN_soln_plot_uniform_repeat_$(q)_$(dt)_$(stepi).png")
